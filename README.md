...
- [ESPnet: end-to-end speech processing toolkit](#espnet-end-to-end-speech-processing-toolkit)
...
- Transformer/RNN-based encoder decoder model for machine translation
...
- Kaldi style complete recipe
  ...
  - Support machine translation recipes (IWSLT'16, Must-C, JESC)
