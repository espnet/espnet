...
espnet/nets/chainer_backend/transformer/decoder.py
...
cov=$(echo "scale = 4; 100 * ${n_blacklist} / ${n_all}" | bc)
echo "not flake8-docstrings ready files coverage: ${n_blacklist} / ${n_all} = ${cov}%"
