...
n_blacklist=0
n_all=$(find ${workdir} -name "*.py" | wc -l)
...
flake8 --show-source --extend-ignore=D test utils doc espnet2 espnet3 test/espnet2 test/espnet3 egs/*/*/local/*.py

# white list of files that should support flake8-docstrings
flake8 --show-source ${workdir}
