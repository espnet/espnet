...
def test_export_vocabulary_to_stdout():
    try:
        export_vocabulary("-", "whisper_en", "INFO")
...
def test_export_vocabulary_en(tmp_path):
    ...
    export_vocabulary(str(tknlist_path), "whisper_en", "INFO")
...
def test_export_vocabulary_invalid():
    with pytest.raises(ValueError):
        export_vocabulary("-", "whisper_aaa", "INFO")
...
def test_main(tmp_path):
    ...
    main(cmd=["--whisper_model", "whisper_multilingual", "--output", str(tknlist_path)])
