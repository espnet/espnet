...
@pytest.fixture()
def asr_turn_take_config_file(tmp_path: Path, token_list):
    # Write default configuration file
    ASRTask.main(
        cmd=[
            "--dry_run",
...
def test_Speech2Text_turn_taking(asr_turn_take_config_file, lm_config_file):
    speech2text = Speech2Text(
        asr_train_config=asr_turn_take_config_file,
        beam_size=1,
        run_chunk=True,
    )
