"""Tests for the esp2_cls system stage hooks."""
...
import espnet3.systems.esp2_cls.system as sysmod
...
def _rls_system(tmp_path, manifests, **overrides):
    ...
    return Esp2ClsSystem(training_config=config)
...
def test_remove_long_short_default_manifest_location(tmp_path, monkeypatch):
    ...
    Esp2ClsSystem(training_config=config).remove_long_short()
...
def test_stage_log_dirs_cover_both_stages(tmp_path):
    ...
    log_dirs = Esp2ClsSystem(training_config=config).stage_log_dirs
