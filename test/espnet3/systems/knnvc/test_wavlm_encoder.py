...
# |---------------------------------------------|------------------------------|
# | test_paper_layer_is_the_constructor_default | layer 6 is the class default,|
# |                                             | not just a recipe value.     |
...
def test_encoder_module_path_is_stable():
    ...
    assert WavLMEncoder.__module__ == "espnet3.systems.knnvc.wavlm_encoder"
...
def test_paper_layer_is_the_constructor_default():
