...
@pytest.mark.parametrize(
    "module, etype, atype, dtype", [
        ...
        ('espnet.nets.chainer_backend.e2e_asr', 'grup', 'location', 'gru'),
        ('espnet.nets.chainer_backend.e2e_asr', 'vggblstmp', 'noatt', 'gru'),
        ('espnet.nets.chainer_backend.e2e_asr', 'blstmp', 'noatt', 'gru'),
        ('espnet.nets.chainer_backend.e2e_asr', 'bgrup', 'noatt', 'gru'),
        ('espnet.nets.chainer_backend.e2e_asr', 'lstmp', 'noatt', 'gru'),
        ('espnet.nets.chainer_backend.e2e_asr', 'grup', 'noatt', 'gru'),
        ('espnet.nets.chainer_backend.e2e_asr', 'vggbgrup', 'dot', 'lstm'),
        ('espnet.nets.chainer_backend.e2e_asr', 'blstmp', 'dot', 'lstm'),
        ('espnet.nets.chainer_backend.e2e_asr', 'bgrup', 'dot', 'lstm'),
        ('espnet.nets.chainer_backend.e2e_asr', 'lstmp', 'dot', 'lstm'),
        ('espnet.nets.chainer_backend.e2e_asr', 'grup', 'dot', 'lstm'),
        ('espnet.nets.pytorch_backend.e2e_asr', 'grup', 'dot', 'lstm'),
        ('espnet.nets.pytorch_backend.e2e_asr', 'grup', 'add', 'lstm'),
        ('espnet.nets.pytorch_backend.e2e_asr', 'lstmp', 'dot', 'lstm'),
        ('espnet.nets.pytorch_backend.e2e_asr', 'lstmp', 'add', 'lstm'),
