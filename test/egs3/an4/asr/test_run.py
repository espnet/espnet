...
RECIPE = Path(__file__).resolve().parents[4] / "egs3/an4/asr"
...
def test_complete_stage_pipeline_on_fixture(corpus, monkeypatch):
    ...
    from egs3.an4.asr.src import tokenizer as tokenizer_module
    from egs3.an4.asr.src.language_model import train_language_model
    ...
    for split in ("train", "valid"):
        training.dataset[split][0].data_src = "egs3.an4.asr.dataset"
    ...
    for entry in inference.dataset.test:
        entry.data_src = "egs3.an4.asr.dataset"
