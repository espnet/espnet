...
test_sens = ["I like apple", "you love coffee", "I love you", "I love coffee"]
@pytest.mark.parameterize(test_sens)
def test_ngram_build(test_sens):
    os.system(f"lmplz --discount_fallback -o 3 {'\n'.join(test_sens)} >tmp.arpa")
    os.system("build_binary tmp.arpa tmp.bin")
