...
dset = ClothoMixupDataset(
    ...
    chatgpt_augmented_data_path=os.path.join(mixup_captions_root_dir,"clotho_development_chatgpt_mixups.json"),
    chatgpt_rejected_data_path=os.path.join(mixup_captions_root_dir,"clotho_development_chatgpt_mixups_err.json"),
