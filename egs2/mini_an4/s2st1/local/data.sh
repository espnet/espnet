...
for x in test test_seg ${train_set} ${train_dev}; do
	cp data/${x}/text data/${x}/text.en
	cp data/${x}/text data/${x}/text.es
	cp data/${x}/wav.scp data/${x}/wav.scp.en
	cp data/${x}/wav.scp data/${x}/wav.scp.es
done

cp data/test_seg/segments data/test_seg/segments.es
cp data/test_seg/segments data/test_seg/segments.en
