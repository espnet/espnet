...
EOF
    ...
    cat > data/test/metric.scp <<'EOF'
fcaw-cen8-b {"utmos": 2.5, "pesq": 1.5, "wer": 10.5}
mmxg-cen8-b {"utmos": 2.5, "pesq": 1.5, "wer": 10.5}
EOF
    cat > data/train_dev/metric.scp <<'EOF'
fash-an251-b {"utmos": 2.5, "pesq": 1.5, "wer": 10.5}
EOF
    cat > data/train_nodev/metric.scp <<'EOF'
fash-an253-b {"utmos": 2.5, "pesq": 1.5, "wer": 10.5}
fbbh-cen8-b {"utmos": 2.5, "wer": 10.5}
mwhw-an152-b {"utmos": 2.5, "pesq": 1.5, "wer": 10.5}
mwhw-cen8-b {"utmos": 2.5, "pesq": 1.5}
EOF
