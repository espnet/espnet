...
# conf/tok_ear_large2k.yaml
# conf/tokenizer_inf_ear_large2k.yaml

tokenizer_inf_config=conf/tokenizer_inf_ear_large2k.yaml
model_size=large
ssl_tag=${model_size}${train_start_iter}.2kvocab
