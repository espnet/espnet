...
ssl_tag=${model_size}.batch8k.steps800k.icme
# ssl_tag=${model_size}.soundmix.auris.icme

if [ $model_size == "large" ]; then
    train_config=conf/pretrain_large_icme.yaml
    # train_config=conf/pretrain_auris_large_icme.yaml
