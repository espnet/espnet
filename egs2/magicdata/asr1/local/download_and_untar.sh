...
if [ $# -ne 3 ]; then
  ...
  echo "<corpus-part> can be one of: train_set, dev_set, test_set, and metadata"
fi
...
part_ok=false
list="train_set dev_set test_set metadata"
for x in $list; do
...
sizes="52627842921 1035537823 2201936013 3886385"
