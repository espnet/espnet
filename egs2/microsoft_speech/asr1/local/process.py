...
def get_train_dev_trs():
    ...
    return train_transcriptions, train_fnames, train_utts, dev_transcriptions, dev_fnames, dev_utts
...
train_transcriptions, train_fnames, train_utts, dev_transcriptions, dev_fnames, dev_utts = get_train_dev_trs()
test_transcriptions, test_fnames, test_utts = get_test_trs()
prepare_files(train_dst_folder, train_audio_folder, train_transcriptions, train_fnames, train_utts)
prepare_files(dev_dst_folder, dev_audio_folder, dev_transcriptions, dev_fnames, dev_utts)
prepare_files(test_dst_folder, test_audio_folder, test_transcriptions, test_fnames, test_utts)