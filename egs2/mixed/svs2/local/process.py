...
def get_parser():
    parser = argparse.ArgumentParser(
        description="Process origin phoneme in music score using unified phoneme tokenizer",
    ...
    parser.add_argument(
        ...
        default="local/dict/aux_ace_dict.txt",
    )
    parser.add_argument(
        "--aux_ace_tails_dict",
        type=str,
        help="bias of tails list on ACE_phoneme",
        default="local/dict/aux_ace_tails_dict.txt",
    )
