...
def video_to_audio(file_path):
    ...
    if nlp2.is_file_exist(f'{file_dir}/{filename}.mp4'):
        ...
        a1 = in1.audio
        out = ffmpeg.output(a1, f'{output_dir}/{filename}.wav', acodec='pcm_s16le', ac=1, ar='16k', vn=None)
        out.run()

if __name__ == '__main__':
    parser = argparse.ArgumentParser()
    parser.add_argument("-s", "--src", type=str, default="/home/itk0123/s2u/mustard", help="Source directory")
    parser.add_argument("-w", "--workers", type=int, default=32, help="Number of workers")
