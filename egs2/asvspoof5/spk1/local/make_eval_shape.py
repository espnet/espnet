...
def main():
    parser = argparse.ArgumentParser(description='Generate speech_shape file for eval set')
    parser.add_argument('--trial_label', type=str, help='Path to the trial label file')
    parser.add_argument('--target_duration', type=float, help='Target duration for each utterance')
