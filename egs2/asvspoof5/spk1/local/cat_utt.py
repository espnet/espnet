...
# This script concatenates a speaker's utterances into a single .flac file
...
def main():
    ...
    parser.add_argument("--enrollment_file", required=True, help="txt with spk n utt")
    parser.add_argument("--out_dir", required=True, help="output dir")

    args = parser.parse_args()

    concatenate_speaker_utterances(args.in_dir, args.enrollment_file, args.out_dir)
