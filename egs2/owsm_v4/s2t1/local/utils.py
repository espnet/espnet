...
class Utterance:
    ...
    confidence: Optional[float] = None  # CTC confidence score
...
class LongUtterance:
    ...
    confidences: Optional[List[float]] = None  # CTC confidence scores
...
def merge_short_utterances(
    ...
    if utts[0].confidence is not None:
        confidences = [u.confidence for u in utts]
    else:
        confidences = None
