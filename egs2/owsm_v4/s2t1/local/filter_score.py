...
def get_parser():
    ...
    parser.add_argument("--in_file", type=str, required=True, help="Input file path containing remaining utterances")
    parser.add_argument("--all_data", type=str, required=True, help="Path to the all data file")
