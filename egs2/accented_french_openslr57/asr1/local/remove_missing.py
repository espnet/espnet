...
def main(cmd=None):
    ...
    new_f = open(base + train + "ca16_conv/new_transcripts.txt", "w",)
    ...
    new_f = open(base + train + "ca16_read/new_conditioned.txt", "w",)
    ...
    new_f = open(base + devtest + "ca16_read/new_conditioned.txt", "w",)
