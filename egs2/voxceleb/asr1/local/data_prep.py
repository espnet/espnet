...
file1=open("/scratch/bbjs/shared/corpora/voxcelebs/voxceleb1/vox1_meta.csv")
...
for x in dir_dict:
    with open(
        ...
        dir_list=os.listdir("/scratch/bbjs/shared/corpora/voxcelebs/voxceleb1/"+dir_dict[x])
        for dir_name in dir_list:
            print(dir_name)
            if dir_name=="txt":
                print("yes")
                continue
            file_list=os.listdir("/scratch/bbjs/shared/corpora/voxcelebs/voxceleb1//"+dir_dict[x]+"/"+dir_name)
            for dir1 in file_list:
                file_list1=os.listdir("/scratch/bbjs/shared/corpora/voxcelebs/voxceleb1//"+dir_dict[x]+"/"+dir_name+"/"+dir1)
                for dir2 in file_list1:
                    data_dir="/scratch/bbjs/shared/corpora/voxcelebs/voxceleb1//"+dir_dict[x]+"/"+dir_name+"/"+dir1+"/"+dir2
