...
asr_expdir=$1
_scoredir="${asr_expdir}/inference_asr_model_valid.acc.ave_10best/valid/score_wer/"
...
_scoredir="${asr_expdir}/inference_asr_model_valid.acc.ave_10best/test/score_wer/"
sclite \
            -r "${_scoredir}/ref_asr.trn" trn \
            -h "${_scoredir}/hyp_asr.trn" trn \
            -i rm -o all stdout > "${_scoredir}/result_asr.txt"
