    ...
    for line in args.segments_file:
        ...
        while dur > dur_threshold:
            ...
            new_utt = "{utt_id}-{s:08d}-{e:08d}".format(
                utt_id=utt_id, s=int(100 * start_relative), e=int(100 * end_relative)
            )
            print(
                "{new_utt} {utt_id} {s:.3f} {e:.3f}".format(
                    new_utt=new_utt,
                    utt_id=utt_id,
                    s=start_relative,
        ...
        print(
            "{new_utt} {utt_id} {s:.3f} {e:.3f}".format(
                new_utt=new_utt, utt_id=utt_id, s=start - start_time, e=end - start_time
            )
        )
