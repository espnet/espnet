...
parser.add_argument('--wav_path', type=str, default=
"/uekai/data/slu/snips/smart-lights-en-close-field/",
                    help='file path for audios')
parser.add_argument('--text_f', type=str, default = 'data/text.trans',
                    help='file path for text')
parser.add_argument('--semantics', type=str, default = 'data/semantics',
                    help='file path for semantics')
parser.add_argument('--utt2spk_f', type=str, default = 'data/utt2spk',
                    help='file path for utt2spk')
parser.add_argument('--wavscp_f', type=str, default = 'data/wav.scp',
                    help='file path for wav.scp')
parser.add_argument('--non_linguistic_symbols', type=str, default = 'data/non_linguistic_symbols.txt',
...
with open(meta,'r') as meta_f, open(args.text_f,
"w") as text_f,open(dataset,'r') as dataset,open(args.non_linguistic_symbols,
"w") as non_linguistic_symbols,open(args.wavscp_f,"w") as wavscp_f, open(
args.utt2spk_f,"w") as utt2spk_f,open(args.semantics,"w") as semantics:
