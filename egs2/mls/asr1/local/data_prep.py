...
def get_parser():
    ...
    parser.add_argument("--lang", type=str, default="pl", choices=["es", "en", "fr", "nl", "it", "pt", "pl", "de"])
...
if __name__ == "__main__":
    ...
    for subdir in ("train", "dev", "test"):
        ...
        if subdir == "train":
            ...
            if args.data_split == "1h" or args.data_split == "10h":
                for one_hr_split in range(6):
                    for line in open(handle_root / "1hr" / str(one_hr_split) / "handles.txt"):
        ...
        for line in tqdm(open(args.source / subdir / "transcripts.txt")):
            ...
            wavdir = args.source / subdir / "audio" / org_spk / book / f"{org_header}.flac"
