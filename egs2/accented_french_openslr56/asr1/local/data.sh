...
if [ ${stage} -le 1 ] && [ ${stop_stage} -ge 1 ]; then
    ...
    cat  downloads/African_Accented_French/transcripts/train/yaounde/fn_text.txt | tail -2098 >  downloads/African_Accented_French/transcripts/train/yaounde/fn_answers_text.txt
