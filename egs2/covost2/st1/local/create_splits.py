...
current_train_dir="data/train."+src_lang+"-"+tgt_lang+"_old"
current_dev_dir="data/dev."+src_lang+"-"+tgt_lang+"_old"
current_test_dir="data/test."+src_lang+"-"+tgt_lang+"_old"
...
for current_dir in [current_train_dir, current_dev_dir, current_test_dir]:
    ...
    if current_dir ==current_train_dir:
        totaldur = 30 * 60 * 60  # (in seconds) 10 hours taken for train split
    else:
