...
if [ ${version} = "v1" ]; then
    ...
    if [ ${lang} = "de" ]; then
        url=https://fbk.sharepoint.com/sites/MTMust-C/_layouts/15/download.aspx?SourceUrl=%2Fsites%2FMTMust%2DC%2FShared%20Documents%2Fdata%2Fpublic%2Fpipeline%5Fv2%2FMUSTC%5Fv2%2E0%5Fen%2Dde%2Etar%2Egz
    elif [ ${lang} = "zh" ]; then
        url=https://fbk.sharepoint.com/sites/MTMust-C/_layouts/15/download.aspx?SourceUrl=%2Fsites%2FMTMust%2DC%2FShared%20Documents%2Fdata%2Fpublic%2Fpipeline%5Fv2%2FMUSTC%5Fv2%2E0%5F%5FKSA%5F%5Fen%2Dzh%5F%5Fwithout%2DH5%2Etar%2Egz
    else
        echo "${lang} is not supported now."
        exit 1;
    fi
