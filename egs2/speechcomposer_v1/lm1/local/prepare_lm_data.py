...
def prepare_tts(
    ...
    for uttid, text in uttid2text.items():
        ...
        res.append(
            f"{uttid} {start_text_token} {text}{enrollment_speech_token}"
...
def prepare_se(
    ...
    for uttid, text in uttid2text.items():
        ...
        res.append(
            f"{uttid} {start_speech_token}{token_source} {generate_text_token}"
...
def prepare_vc(
    ...
    for uttid, text in uttid2text.items():
        ...
        res.append(
            f"{uttid} {start_speech_token}{token_source} "
