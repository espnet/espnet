...
def prepare_tts(
    ...
    for uttid, text in uttid2text.items():
        ...
        res.append(
            f"{uttid} {start_text_token} {text}{enrollment_speech_token}{enroll_token}{generate_speech_token}{token}"
        )
...
def prepare_se(
    ...
    for uttid, text in uttid2text.items():
        ...
        res.append(
            f"{uttid} {start_speech_token}{token_source} {generate_text_token} {text}{enrollment_speech_token}{enroll_token}{generate_speech_token}{token_target}"
        )
...
if __name__ == "__main__":
    ...
    if use_enroll_speech:
        ...
        vc_enrollment_dict = prepare_enroll_speech_dict(
            out_dir / "speech/vc/token_source"
        )
        se_enrollment_dict = prepare_enroll_speech_dict(
            out_dir / "speech/se/token_source"
        )
