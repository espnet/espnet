...
def detect_face_landmarks(
    face_predictor_path, cnn_detector_path, source_video_dir, landmark_dir, rank, nshard
):
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--video_source_dir",
        type=str,
        default="/nfs-02/yuyue/visualtts/dataset/lrs2/video_25fps",
        help="root dir",
    )
    parser.add_argument(
        "--landmark_dir",
        default="/nfs-02/yuyue/visualtts/DSU-AVO-main/avhubert/preparation/data/lrs2/landmark",
        type=str,
        help="landmark dir",
    )
    parser.add_argument(
        "--cnn_detector",
        default="/nfs-02/yuyue/visualtts/reference_code/espnet/egs2/lrs2/avhubert/local/pretrained/cnn_detector.dat",
        type=str,
        help="path to cnn detector (download and unzip from: http://dlib.net/files/mmod_human_face_detector.dat.bz2)",
    )
    parser.add_argument(
        "--face_predictor",
        default="/nfs-02/yuyue/visualtts/reference_code/espnet/egs2/lrs2/avhubert/local/pretrained/face_predictor.dat",
        type=str,
