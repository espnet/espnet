...
Usage: $0 [--stage <stage>] [--stop_stage <stop_stage>] [--configure <conf.json>]
  optional argument:
    ...
    NOTE:
        ...
        You can clone the DNS-icassp2021 by git clone https://github.com/microsoft/DNS-Challenge.git DNS-Challenge
        You can download the data by using download-dns-challenge-2.sh in the master branch
