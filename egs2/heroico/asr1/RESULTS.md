> **Note:** the numbers below are from the pre-resplit training run
> (speaker-disjoint only). A retrain on the new text-disjoint split
> (see README "Data split" section) is in progress; this file will be
> updated once that completes. Tracked in PR #6491.
