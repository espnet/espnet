...
if __name__ == "__main__":
    ...
    parser.add_argument("-i","--inp", type=str, help="Input file with all training data")
    parser.add_argument("-o","--out", type=str, help="Output file for bpe training")
    parser.add_argument("-n","--num", type=int, default=700000, help="Number of utterances to be used for bpe traning")
