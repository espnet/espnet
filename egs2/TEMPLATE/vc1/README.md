...
This is a template of voice conversion recipe for ESPnet2.

## Table of Contents

* [ESPnet2 Voice Conversion Recipe TEMPLATE](#espnet2-vc-recipe-template)
  ...
  * [Recipe flow](#recipe-flow)
    ...
    * [5\. VC statistics collection](#5-tts-statistics-collection)
    * [6\. VC training](#6-tts-training)
    * [7\. voice converting](#7-tts-decoding)
    * [8\-9\. (Optional) Pack results for upload](#8-9-optional-pack-results-for-upload)
  * [How to run](#how-to-run)
    * [AutoVC training](#autovc-training)
