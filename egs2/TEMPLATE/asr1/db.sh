...
DNS=
DSING=downloads
WSJ0=/mnt/shared_storage/original/csr_1
WSJ1=/mnt/shared_storage/original/csr_2_comp
WSJCAM0=/mnt/shared_storage/original/csr_2_comp
REVERB=/mnt/audio-research-datasets/robin/datasets/REVERB
# REVERB_OUT="${PWD}/REVERB"  # Output file path
REVERB_OUT=${REVERB}/REVERB_DATA
CHIME3=/mnt/shared_storage/original/CHiME3
CHIME4=/mnt/shared_storage/original/CHiME4_robin
CSJDATATOP=
