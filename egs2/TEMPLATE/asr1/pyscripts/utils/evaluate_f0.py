...
def get_parser() -> argparse.Namespace:
    ...
    parser.add_argument("--f0min", default=40, type=int, help="Minimum f0 value.")
    parser.add_argument("--f0max", default=800, type=int, help="Maximum f0 value.")
    parser.add_argument("--nj", default=16, type=int, help="Number of parallel jobs.")
    parser.add_argument(
        "--verbose",
        default=1,
        type=int,
