...
if [ ${stage} -le 3 ] && [ ${stop_stage} -ge 3 ]; then
    log "data stage 3: VAD data preparation"
    # use segments for ASR task to generate text for VAD task
    for dset in train dev eval; do
        python local/generate_vad_file.py data/${mic}_${dset}/segments data/${mic}_${dset}/text data/${mic}_${dset}/wav.scp data/${mic}_${dset}/utt2spk
        # transform utt2spk to spk2utt
        utils/utt2spk_to_spk2utt.pl data/${mic}_${dset}/utt2spk > data/${mic}_${dset}/spk2utt
    done
fi
