...
def main():
    ...
    for dt in data_types:
        try:
            df_train = pd.read_excel(metadata_base_path / f"{dt}_train.xlsx").set_index('id')
            df_dev = pd.read_excel(metadata_base_path / f"{dt}_dev.xlsx").set_index('id')
            df_test = pd.read_excel(metadata_base_path / f"{dt}_test.xlsx").set_index('id')
