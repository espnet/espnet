...
if [ $num_spkrs -eq 1 ]; then
  ...
  compute-perm-free-error.py --num-spkrs ${num_spkrs} ${dir}/result_r1h1.txt ${dir}/result_r1h2.txt \
  ...
  if ${wer}; then
      ...
      compute-perm-free-error.py --num-spkrs ${num_spkrs} ${dir}/result_r1h1.wrd.txt ${dir}/result_r1h2.wrd.txt \
