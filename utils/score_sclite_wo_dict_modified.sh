...
if [ $num_spkrs -eq 1 ]; then
    ...
    python ../../../utils/make_trn_from_wrd-trn.py -i ${dir}/hyp.wrd.trn -o ${dir}/hyp.trn
    python ../../../utils/make_trn_from_wrd-trn.py -i ${dir}/ref.wrd.trn -o ${dir}/ref.trn
    ...
    python ../../../utils/make_pinyin-trn_from_wrd-trn.py -i ${dir}/hyp.wrd.trn -o ${dir}/hyp.py.trn
    python ../../../utils/make_pinyin-trn_from_wrd-trn.py -i ${dir}/ref.wrd.trn -o ${dir}/ref.py.trn
