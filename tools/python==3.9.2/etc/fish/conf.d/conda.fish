set -gx CONDA_EXE "/media/samco/Data1/CHiME7_espnet/espnet/tools/python==3.9.2/bin/conda"
set _CONDA_ROOT "/media/samco/Data1/CHiME7_espnet/espnet/tools/python==3.9.2"
set _CONDA_EXE "/media/samco/Data1/CHiME7_espnet/espnet/tools/python==3.9.2/bin/conda"
set -gx CONDA_PYTHON_EXE "/media/samco/Data1/CHiME7_espnet/espnet/tools/python==3.9.2/bin/python"
