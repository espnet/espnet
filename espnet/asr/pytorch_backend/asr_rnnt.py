...
def train(args):
    ...
    # define rnn-trans or rnnt-trans with att.
    if args.rnnt_mode == 1:
    ...
    updater = CustomUpdater(
        ...
        args.grad_noise, args.accum_grad)
    ...
    if args.num_save_attention > 0 and args.rnnt_mode == 1:
    ...
    if args.batchsize <= 1:
        ...
        with torch.no_grad():
            for names in grouper(args.batchsize, keys, None):
                ...
                nbest_hyps = model.recognize_batch(feats, args, train_args.char_list, rnnlm)
