...
def main(args):
    ...
    # encoder
    parser.add_argument('--num-spkrs', default=2, type=int,
                        choices=[2],
                        help='Number of speakers in the mixed speech.')
    ...
    parser.add_argument('--elayers-sd', default=4, type=int,
                        help='Number of encoder layers for speaker differentiate part')
    parser.add_argument('--elayers-rec', default=4, type=int,
