...
class Encoder(torch.nn.Module):
    ...
    :param bool: whether to use relative positional encoding
    ...
    :param bool convolution_block: whether to use convolution block
    :param int kernel_sie: kernerl size of convolution block
    :param str act_type: use which type of activation functions
    ...
    def __init__(
        ...
        if macaron_style and positionwise_layer_type != "linear":
            raise ValueError(
                "Only support using macaron style with linear type positionwise layer"
            )
        ...
        if convolution_block:
            convolution_layer = ConvolutionBlock(
                attention_dim, kernel_size, activation=activation
            )
        else:
        ...
        self.encoders = repeat(
            ...
            lambda: EncoderLayer(
                attention_dim,
                attention_layer(attention_heads, attention_dim, attention_dropout_rate),
