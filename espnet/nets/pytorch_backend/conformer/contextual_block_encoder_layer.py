...
@author: University of Chinese Academy of Sciences (Keqi Deng)
"""
...
#                doc=open('/ceph/sz_ts80_new/keqideng/repository/tools/newone/espnet-dev-real_streaming_decoder/egs2/aishell/asr1/log.txt','a')
#                print(x[:, 0, 0, :].shape,file=doc)
#                print(past_ctx[:, layer_idx, :].shape,file=doc)
#                doc.close()
