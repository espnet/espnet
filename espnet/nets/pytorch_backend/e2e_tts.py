...
#        mel_fbank_b = np.transpose(before_outs[0].detach().cpu().numpy())
#        mel_fbank_a = np.transpose(after_outs[0].detach().cpu().numpy())
#        #mel_fbank_l = np.transpose(logits[0].detach().cpu().numpy())
#        gt_mel_fbank = np.transpose(ys[0].detach().cpu().numpy())
#        ax1.imshow(mel_fbank_b, aspect='auto', cmap=plt.cm.jet)
#        ax2.imshow(mel_fbank_a, aspect='auto', cmap=plt.cm.jet)
