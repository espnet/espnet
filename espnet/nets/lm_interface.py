...
predefined_lms = {
    ...
    "chainer": {
        "default": "espnet.nets.chainer_backend.lm.default:DefaultRNNLM",
        "seq_rnn": "espnet.nets.chainer_backend.lm.seq_rnn:SequentialRNNLM",
        "transformer": "espnet.nets.chainer_backend.lm.transformer:TransformerLM",
    }
}
