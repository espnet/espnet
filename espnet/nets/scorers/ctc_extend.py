...
from espnet.nets.ctc_prefix_score_extend import CTCPrefixScoreExtend
from espnet.nets.ctc_prefix_score_extend import CTCPrefixScoreExtendTH
from espnet.nets.scorer_interface import BatchPartialScorerInterface


class CTCPrefixExtendScorer(BatchPartialScorerInterface):
    """Decoder interface wrapper for CTCPrefixScoreExtend."""
    ...
    def init_state(self, x: torch.Tensor):
        ...
        # TODO(karita): use CTCPrefixScoreExtendTH
        self.impl = CTCPrefixScoreExtend(logp, 0, self.eos, np)
    ...
    def select_state(self, state, i, new_id=None):
        ...
        """
        if type(state) == tuple:
            if len(state) == 2:  # for CTCPrefixScoreExtend
                sc, st = state
                return sc[i], st[i]
    ...
    def batch_init_state(self, x: torch.Tensor):
        ...
        self.impl = CTCPrefixScoreExtendTH(logp, xlen, 0, self.eos)
        return None
