...
class E2E(torch.nn.Module):
    ...
    def __init__(self, idim, odim, args, asr_model=None, mt_model=None):
        ...
        if args.atype == 'noatt':
            ...
            sys.exit()
        # decoder
        if not hasattr(args, 'replace_sos'):
            setattr(args, 'replace_sos', False)
        if args.mt_decoder:
            from espnet.nets.e2e_mt_th import MTDecoder
            self.dec = MTDecoder(args.eprojs, odim, args.dlayers, args.dunits,
                                 ...
                                 args.dropout_rate, args.replace_sos)
        else:
        ...
        if asr_model is not None:
            ...
            asr_enc_param_dict = dict(asr_model.predictor.enc.named_parameters())
        ...
        if mt_model is not None:
            ...
            mt_dec_param_dict = dict(mt_model.predictor.dec.named_parameters())
    ...
    def forward(self, xs_pad, ilens, ys_pad):
        ...
        if self.mtlalpha == 1:
            ...
            loss_att, acc = self.dec(hs_pad, hlens, ys_pad)[:2]
