...
def align(lpz, char_list, ground_truth, utt_begin_indices, skip_prob):   
    ...
    window_len = 8000#args.start_win
...
def compute_utt_boundaries(utt_begin_indices, char_probs, timings, text):
...
def align_run(enc, text, char_list):
    ...
    return compute_utt_boundaries(utt_begin_indices, char_probs, timings, text)
