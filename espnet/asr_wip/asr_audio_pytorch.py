...
class CustomUpdater(training.StandardUpdater):
    ...
    def __init__(self, asr2tts_model, asr_model, tts_model,
                 grad_clip_threshold, train_iter,
                 optimizer_A, asr_converter, tts_converter, device, ngpu,
                 update_asr_only=False, freeze_asr=False, freeze_tts=False):
        super(CustomUpdater, self).__init__(train_iter, optimizer_A)
...
def train(args):
    ...
    train = make_batchset(train_json[0], args.batch_size, args.maxlen_in,
