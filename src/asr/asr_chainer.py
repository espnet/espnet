...
def train(args):
    ...
    if ngpu <= 1:
        ...
        train_iter = chainer.iterators.MultiprocessIterator(
            ...
            n_proesses=4, n_prefetch=32, maxtasksperchild=20)
        ...
        train_iters = [chainer.iterators.MultiprocessIterator(
            ...
            1, n_proesses=4 * ngpu, n_prefetch=32, maxtasksperchild=20)
            for gid in six.moves.xrange(ngpu)]
    ...
    valid_iter = chainer.iterators.MultiprocessIterator(
        ...
        1, n_proesses=2, n_prefetch=32, repeat=False, shuffle=False, maxtasksperchild=20)
