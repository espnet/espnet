...
def main():
    ...
    # task related
    # noisy
    parser.add_argument('--train-feat-noisy', type=str, required=True,
                        help='Filename of train feature data (Kaldi scp) without enhancement')
    parser.add_argument('--valid-feat-noisy', type=str, required=True,
                        help='Filename of validation feature data (Kaldi scp) without enhancement')
    parser.add_argument('--train-label-noisy', type=str, required=True,
                        help='Filename of train label data (json) without enhancement')
    parser.add_argument('--valid-label-noisy', type=str, required=True,
                        help='Filename of validation label data (json) without enhancement')
    # enhan
    parser.add_argument('--train-feat-enhan', type=str, nargs='*', required=True,
                        help='Filename list of train feature data (Kaldi scp) with enhancement')
    parser.add_argument('--valid-feat-enhan', type=str, nargs='*', required=True,
                        help='Filename list of validation feature data (Kaldi scp) with enhancement')
    parser.add_argument('--train-label-enhan', type=str, required=True,
                        help='Filename of train label data (json) with enhancement')
    parser.add_argument('--valid-label-enhan', type=str, required=True,
                        help='Filename of validation label data (json) with enhancement')
    # network archtecture
    # encoder
    parser.add_argument('--etype', default='blstmp', type=str,
                        choices=['blstm', 'blstmp'],
    ...
    parser.add_argument('--btype', default='blstmp', type=str,
                        choices=['blstmp'],
                        help='Type of beamformer network architecture')
    parser.add_argument('--blayers', default=3, type=int,
                        help='Number of beamformer layers')
    parser.add_argument('--bunits', default=300, type=int,
                        help='Number of beamformer hidden units')
    parser.add_argument('--bprojs', default=320, type=int,
                        help='Number of beamformer projection units')
    parser.add_argument('--badim', default=320, type=int,
                        help='Number of attention transformation dimensions in beamformer')
