...
(``model._target_: espnet3.systems.f5_tts.inference.F5TTSInference``).
...
from espnet3.systems.f5_tts import (
...
class F5TTSInference:
    ...
    def __init__(
        ...
        Example:
            .. code-block:: yaml
                ...
                inference:
                  _target_: espnet3.systems.f5_tts.inference.F5TTSInference
    ...
    def _build_tokenizer(self, config: dict) -> None:
        ...
        if "F5PinyinPreprocessor" in target or preprocessor_config.get("vocab_file"):
            ...
            from espnet3.systems.f5_tts.pinyin import (
                load_vocab_char_map,
                text_to_pinyin_ids,
            )
        ...
        if preprocessor_config.get("g2p_type") == "f5_pinyin":
            from espnet3.systems.f5_tts.pinyin import register_f5_pinyin_g2p
