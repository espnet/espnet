...
Note: This file is a copy of the corresponding espnet2 task class, with the
ESPnet SSL frontend registered and the ESPnet3 verification model wired in.
"""
...
class SpeakerTask(AbsTask):
    """Speaker task definition for argument wiring and model construction."""
    ...
    def add_task_arguments(cls, parser: argparse.ArgumentParser):
        """Add speaker-specific task arguments to the parser."""
    ...
    def build_collate_fn(cls, args: argparse.Namespace, train: bool) -> Callable[
        ...
        """Build the collate function for speaker batches."""
    ...
    @classmethod
    @typechecked
    def build_model(cls, args: argparse.Namespace) -> ESPnetSpeakerVerificationModel:
        """Build the speaker embedding model from parsed arguments."""
        ...
        model = ESPnetSpeakerVerificationModel(
            frontend=frontend,
            specaug=specaug,
            normalize=normalize,
            encoder=encoder,
