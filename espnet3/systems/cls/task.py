...
class CLSTask(AbsTask):
    """CLS task definition for argument wiring and model construction."""
    ...
    def add_task_arguments(cls, parser: argparse.ArgumentParser):
        """Add classification-specific task arguments to the parser."""
    ...
    def build_collate_fn(cls, args: argparse.Namespace, train: bool) -> Callable[
        ...
        """Build the collate function for classification batches."""
    ...
    def build_preprocess_fn(
        ...
        """Build the preprocessing function for classification inputs."""
