...
- [ ] modified or new python scripts should be passed through **latest** black formating (by using python package black)
...
- [ ] add corresponding entry in `egs2/TEMPLATE/db.sh`
