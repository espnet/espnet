...
# config files
train_config=conf/train_pytorch_fastspeech+spkemb.yaml
decode_config=conf/decode.yaml

# decoding related
model=snapshot.ep.2500
...
# exp tag
tag="cdvqvae_codebook_128_fastspeech" # tag for managing experiments.
