...
wget -c -N https://ftp.espci.fr/pub/sigma/TIMIT_training/TIMIT_Transcripts.txt -P ${timit_dir}
wget -c -N https://ftp.espci.fr/pub/sigma/WSJ05K_Test/WSJ0_5K_Transcripts.txt -P ${timit_dir}
...
for x in train test;do
    ...
    | sed "s%/home/jiyan/kaldi-update/egs/jiyan/dct30-wsj/voxforge/mfcc/%"${PWD}"/data/timit_data/%g" \
    | sed "s%/home/jiyan/kaldi-update/egs/jiyan/s5-jiyan1.1/voxforge/mfcc/%"${PWD}"/data/timit_data/%g" \
    > data/${x}/feats.scp
done
