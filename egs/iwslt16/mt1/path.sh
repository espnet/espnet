...
export PATH=$MAIN_ROOT/tools/moses/scripts/tokenizer/:$MAIN_ROOT/tools/moses/scripts/generic/:$MAIN_ROOT/tools/moses/scripts/recaser/:$MAIN_ROOT/tools/moses/scripts/training/:$PATH
