...
local/ob_eval/data_prep_for_asr.sh ${outdir}_denorm/${name}/wav ${asr_data_dir}/${name} ${spk}
cp data/${name}/text ${asr_data_dir}/${name}/text # TODO: (dirty) should replace `data` with some argument
