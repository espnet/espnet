...
# detokenize
detokenizer.perl -l es -q < ${dir}/ref.wrd.trn > ${dir}/ref.wrd.trn.detok
detokenizer.perl -l es -q < ${dir}/hyp.wrd.trn > ${dir}/hyp.wrd.trn.detok
detokenizer.perl -l es -q < ${dir}/src.wrd.trn > ${dir}/src.wrd.trn.detok
if [ ! -z ${set} ] && [ -f ${dir}/data_ref1.json ]; then
    detokenizer.perl -l es -q < ${dir}/ref1.wrd.trn > ${dir}/ref1.wrd.trn.detok
    detokenizer.perl -l es -q < ${dir}/ref2.wrd.trn > ${dir}/ref2.wrd.trn.detok
    detokenizer.perl -l es -q < ${dir}/ref3.wrd.trn > ${dir}/ref3.wrd.trn.detok
fi
