...
if __name__ == "__main__":
    ...
    parser.add_argument('-w', dest="wav_path", type=str, help="wav path", default="remixed")
    parser.add_argument('-i', dest='speaker_info', type=str, help='speaker info file dir', default='local/speaker_wav_mapping_nahuatl_test.csv')
    parser.add_argument('-n', dest='new_data_dir', type=str, help='new data directory', default='packed')
    ...
    for root, dirs, files in os.walk(args.wav_path):
        for wav in files:
            ...
            os.system("cp %s %s" %(os.path.join(root, wav), os.path.join(args.new_data_dir, new_filename)))
