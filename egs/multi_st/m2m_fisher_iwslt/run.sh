...
recog_set_iwslt="et_iwslt18_tst2013.de et_iwslt18_tst2014.de et_iwslt18_tst2015.de"
...
if [ ${stage} -le 1 ] && [ ${stop_stage} -ge 1 ]; then
    ...
    utils/combine_data.sh --extra_files "text.tc text.lc text.lc.rm" data/${train_set} data/tr_fisher_callhome.en data/tr_iwslt18.de
    utils/combine_data.sh --extra_files "text.tc text.lc text.lc.rm" data/${train_dev} data/dt_fisher_callhome.en data/dt_iwslt18.de
    ...
    for rtask in ${recog_set_fisher} ${recog_set_iwslt}; do
...
if [ ${stage} -le 2 ] && [ ${stop_stage} -ge 2 ]; then
    ...
    grep sp1.0 data/tr_fisher_callhome*/text.${case} data/tr_iwslt18*/text.${case} | cut -f 2- -d " " | grep -o -P '&[^;]*;|<[^>]*>' | sort | uniq > ${nlsyms}
    cat ${nlsyms}

    echo "make a dictionary"
    echo "<unk> 1" > ${dict} # <unk> must be 1, 0 will be used for "blank" in CTC
    grep sp1.0 data/tr_fisher_callhome*/text.${case} data/tr_iwslt18*/text.${case} | text2token.py -s 1 -n 1 -l ${nlsyms} | cut -f 2- -d" " | tr " " "\n" \
