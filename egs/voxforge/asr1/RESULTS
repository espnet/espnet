...
# Transformer 300 epochs, decoder 1 layer 1024 units (conf/tuning/train_pytorch_transformer.yaml)
...
# Transformer 300 epochs, decoder 6 layer 2048 units (conf/tuning/train_pytorch_transformer_d6-2048.yaml)
# It takes very long time for the decoding and I don't recommend to use this setup without speed improvement during decoding
