...
train_config=conf/finetunevideo/trainvideo.yaml
...
ln -rsf  local/finetunevideo ${MAIN_ROOT}/espnet/finetunevideo  || exit 1;
rm -rf $MAIN_ROOT/espnet/bin/asr_train_video.py   || exit 1;
ln -rsf  local/finetunevideo/asr_train_video.py $MAIN_ROOT/espnet/bin/asr_train_video.py   || exit 1;
rm -rf $MAIN_ROOT/espnet/bin/asr_recog_video.py  || exit 1;
ln -rsf  local/finetunevideo/asr_recog_video.py $MAIN_ROOT/espnet/bin/asr_recog_video.py  || exit 1;
