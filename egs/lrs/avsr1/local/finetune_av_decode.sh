...
train_config=conf/finetuneav/trainavs.yaml
...
ln -rsf  local/finetuneav ${MAIN_ROOT}/espnet/finetuneav  || exit 1;
ln -rsf  local/finetuneav/e2e_asr_transformerdecode.py ${MAIN_ROOT}/espnet/finetuneav/e2e_asr_transformer.py  || exit 1;
rm -rf $MAIN_ROOT/espnet/bin/asr_train_avrms.py   || exit 1;
ln -rsf  local/finetuneav/asr_train_avrms.py $MAIN_ROOT/espnet/bin/asr_train_avrms.py   || exit 1;
rm -rf $MAIN_ROOT/espnet/bin/asr_recog_avrms.py  || exit 1;
ln -rsf  local/finetuneav/asr_recog_avrms.py $MAIN_ROOT/espnet/bin/asr_recog_avrms.py  || exit 1;
