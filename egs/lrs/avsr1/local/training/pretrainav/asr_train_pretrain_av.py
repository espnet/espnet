...
def get_parser(parser=None, required=True):
    ...
    parser.add_argument(
        ...
        type=int,
        metavar="ML",
        help="When --batch-count=seq, batch size is reduced if "
        "the input sequence length > ML.",
    )
    parser.add_argument(
        "--maxlen-out",
    ...
    parser.add_argument("--pretrain-audio-model", type=str, required=True, help="")
    parser.add_argument("--pretrain-video-model", type=str, required=True, help="")
