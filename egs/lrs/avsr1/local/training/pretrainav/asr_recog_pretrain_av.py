...
def get_parser():
    parser = configargparse.ArgumentParser(
        description="Transcribe text from speech using a speech recognition model on"
        " one CPU or GPU",
...
v2: Experimental API. It supports any models that implements ScorerInterface.""",
    ...
    parser.add_argument(
        "--model", required=True, type=str, help="Model file parameters to read"
    )
    parser.add_argument(
    ...
    # rnnlm related
    parser.add_argument(
        "--rnnlm", type=str, required=True, help="RNNLM model file to read"
    )
    parser.add_argument(
