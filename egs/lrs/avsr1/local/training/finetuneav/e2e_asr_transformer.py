...
from espnet.finetuneav.attention import (
    MultiHeadedAttention as transfMultiHeadedAttention,
)
...
class E2E(ASRInterface, torch.nn.Module):
    ...
    def __init__(self, aidim, vidim, odim, args, ignore_id=-1):
        ...
        self.vencoder = vEncoder(
            idim=256,
            pretrained_video_extractor=args.pretrain_video_extractor,
            attention_dim=args.adim,
            attention_heads=args.aheads,
            linear_units=args.eunits,
            num_blocks=args.elayers,
        ...
        for i in six.moves.range(maxlen):
            ...
            for hyp in hyps:
                ...
                if lpz is not None:
                    ...
                    local_scores = attw * local_att_scores[
                        :, local_best_ids[0]
