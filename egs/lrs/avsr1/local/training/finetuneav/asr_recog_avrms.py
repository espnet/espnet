...
def get_parser():
    ...
    parser.add("--config", default=True, is_config_file=True, help="Config file path")
    parser.add(
        "--config2",
        is_config_file=True,
...
v2: Experimental API. It supports any models that implements ScorerInterface.""",
    ...
    parser.add_argument(
        "--model", default=True, type=str, help="Model file parameters to read"
    )
    parser.add_argument(
    ...
    # rnnlm related
    parser.add_argument(
        "--rnnlm", type=str, default=True, help="RNNLM model file to read"
    )
    parser.add_argument(
