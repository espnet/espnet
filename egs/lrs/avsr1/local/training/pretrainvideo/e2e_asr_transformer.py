...
from espnet.pretrainvideo.decoder import Decoder
from espnet.nets.pytorch_backend.transformer.encoder import Encoder
from espnet.pretrainvideo.ctcencoder import Encoder as ctcEncoder
from espnet.nets.pytorch_backend.transformer.initializer import initialize
from espnet.nets.pytorch_backend.transformer.label_smoothing_loss import (
    LabelSmoothingLoss,
)
from espnet.nets.pytorch_backend.transformer.mask import subsequent_mask
from espnet.pretrainvideo.plot import PlotAttentionReport
...
class E2E(ASRInterface, torch.nn.Module):
    ...
    def add_arguments(parser):
        ...
        group.add_argument(
            ...
            default=4,
            type=int,
            help="Number of encoder layers (for shared recognition part in \
                    multi-speaker asr mode)",
        )
        group.add_argument(
            "--eunits",
            "-u",
    ...
    def recognize(self, feat, recog_args, char_list=None, rnnlm=None, use_jit=False):
        ...
        if len(nbest_hyps) == 0:
            logging.warning(
                "there is no N-best results, perform recognition again with \
                smaller minlenratio."
            )
