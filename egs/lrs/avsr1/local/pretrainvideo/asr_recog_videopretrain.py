...
def get_parser():
    ...
    parser.add('--config', required=True, is_config_file=True,
...
v2: Experimental API. It supports any models that implements ScorerInterface.''')
    # task related
    parser.add_argument('--recog-json', required=True, type=str,
                        help='Filename of recognition data (json)')
    parser.add_argument('--result-label', required=True, type=str,
    ...
    # rnnlm related
    parser.add_argument('--rnnlm', type=str, required=True,
        ...
        if args.backend == "chainer":
            ...
            if args.num_encs == 1:
                ...
                if args.api == "v2":
                    ...
                    from espnet.pretrainvideo.asr import recog
