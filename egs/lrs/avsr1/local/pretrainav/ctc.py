...
from espnet.pretrainav.weighttransfn import ctcNet
...
class CTC(torch.nn.Module):
    ...
    def forward(self, ahs_pad, vhs_pad, ctcinfo, hlens, ys_pad):
        ...
        catctcfeats = torch.cat((torch.softmax(ays_hat, dim=-1), torch.softmax(vys_hat, dim=-1), ctcinfo), dim=-1)
