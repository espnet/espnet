...
from espnet.finetuneav.asr_utils import torch_resume
from espnet.asr.asr_utils import torch_snapshot
from espnet.finetuneav.asr_init import load_trained_model
from espnet.finetuneav.asr_utils import torch_load_pretrained_av
from espnet.finetuneav.asr_utils import torch_load_pretrained_audio
from espnet.finetuneav.asr_utils import torch_load_pretrained_video
from espnet.finetuneav.asr_utils import torch_load_pretrained
...
from espnet.finetuneav.io_utils import LoadInputsAndTargets
from espnet.finetuneav.batchfy import make_batchset
...
def train(args):
    ...
    if args.pretrain_av_model:
        logging.info('load pretrained model from %s' % args.pretrain_av_model)
        torch_load_pretrained_av(args.pretrain_av_model, trainer)    
