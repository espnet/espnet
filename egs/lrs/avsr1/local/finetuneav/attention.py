...
class MultiHeadedAttention(nn.Module):
    ...
    def __init__(self, n_head, n_feat, dropout_rate):
        ...
        self.linear_rmv = nn.Linear(n_feat, n_feat)
        self.linear_out = nn.Linear(n_feat, n_feat)
        self.linear_rmout = nn.Linear(n_feat, n_feat)
        self.attn = None
    ...
    def forward(self, query, key, value, mask, rmvalue):
        ...
        rmx = rmx.transpose(1, 2).contiguous().view(n_batch, -1, self.h * self.d_k)  # (batch, time1, d_model)
