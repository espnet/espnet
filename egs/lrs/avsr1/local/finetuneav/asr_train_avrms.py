...
def get_parser(parser=None, required=True):
    ...
    ##############################################################################
    parser.add('--config', required=True, type=str,
    ...
    parser.add_argument('--minibatches', '-N', type=int, default='0',
    ...
    parser.add_argument('--tensorboard-dir',
                        required=True,
                        type=str, nargs='?', help="Tensorboard log dir path")
    ##############################################################################
    ...
    parser.add_argument('--preprocess-conf', type=str, required=True, nargs='?',
    ...
    parser.add_argument('--fbank-fmax', type=float, default=None,
                        help='')
    parser.add_argument('--pretrain-video-extractor', type=str,
                        required=True,
                        help='')
    parser.add_argument('--pretrain-av-model', type=str,
                        default=True,
                        help='')
...
def main(cmd_args):
    ...
    if args.num_spkrs == 1:
        if args.backend == "chainer":
            ...
            from espnet.finetuneav.asr import train
            train(args)
        else:
