...
def get_parser():
    ...
    parser.add('--config', default=True, is_config_file=True,
...
v2: Experimental API. It supports any models that implements ScorerInterface.''')
    # task related
    parser.add_argument('--recog-json', default=True, type=str,
                        help='Filename of recognition data (json)')
    parser.add_argument('--result-label', default=True, type=str,
                        help='Filename of result label data (json)')
    # model (parameter) related
    parser.add_argument('--model', default=True, type=str,
    ...
    # rnnlm related
    parser.add_argument('--rnnlm', type=str, default=True,
        ...
        if args.backend == "chainer":
            ...
            if args.num_encs == 1:
                ...
                if args.api == "v2":
                    ...
                    from espnet.finetuneav.asr import recog
