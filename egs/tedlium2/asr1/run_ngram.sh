...
if [ ${stage} -le 3 ] && [ ${stop_stage} -ge 3 ]; then
	...
	> ${lmdatadir}/valid.txt
    lmplz -o 5 <${lmdatadir}/train.txt >${lmexpdir}/${bpemodel}_${n_gram}gram.arpa
    build_binary -s ${lmexpdir}/${bpemodel}_${n_gram}gram.arpa ${lmexpdir}/${bpemodel}_${n_gram}gram.bin
fi
...
if [ ${stage} -le 5 ] && [ ${stop_stage} -ge 5 ]; then
    ...
    (
        ...
        ${decode_cmd} JOB=1:${nj} ${expdir}/${decode_dir}/log/decode.JOB.log \
            ...
            --api v2 \
            --ngram ${lmexpdir}/${bpemodel}_${n_gram}gram.bin 
