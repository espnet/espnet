...
if [ -f $srcdir/text.tc.1 ]; then
  utils/apply_map.pl -f 1 $destdir/utt_map <$srcdir/text.tc.1 >$destdir/text.tc.1
  utils/apply_map.pl -f 1 $destdir/utt_map <$srcdir/text.tc.2 >$destdir/text.tc.2
  utils/apply_map.pl -f 1 $destdir/utt_map <$srcdir/text.tc.3 >$destdir/text.tc.3
fi
if [ -f $srcdir/text.lc ]; then
  utils/apply_map.pl -f 1 $destdir/utt_map <$srcdir/text.lc >$destdir/text.lc
fi
if [ -f $srcdir/text.lc.1 ]; then
  utils/apply_map.pl -f 1 $destdir/utt_map <$srcdir/text.lc.1 >$destdir/text.lc.1
  utils/apply_map.pl -f 1 $destdir/utt_map <$srcdir/text.lc.2 >$destdir/text.lc.2
  utils/apply_map.pl -f 1 $destdir/utt_map <$srcdir/text.lc.3 >$destdir/text.lc.3
fi
if [ -f $srcdir/text.lc.rm ]; then
  utils/apply_map.pl -f 1 $destdir/utt_map <$srcdir/text.lc.rm >$destdir/text.lc.rm
fi
if [ -f $srcdir/text.lc.rm.1 ]; then
  utils/apply_map.pl -f 1 $destdir/utt_map <$srcdir/text.lc.rm.1 >$destdir/text.lc.rm.1
  utils/apply_map.pl -f 1 $destdir/utt_map <$srcdir/text.lc.rm.2 >$destdir/text.lc.rm.2
  utils/apply_map.pl -f 1 $destdir/utt_map <$srcdir/text.lc.rm.3 >$destdir/text.lc.rm.3
fi
