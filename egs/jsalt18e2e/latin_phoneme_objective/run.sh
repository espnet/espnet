...
train_set=tr_babel_latin
train_dev=dt_babel_latin

# Languages with Latin script
recog_set="dt_babel_haitian et_babel_haitian dt_babel_kurmanji
et_babel_kurmanji dt_babel_swahili et_babel_swahili dt_babel_tagalog
et_babel_tagalog dt_babel_tokpisin et_babel_tokpisin dt_babel_turkish
et_babel_turkish dt_babel_zulu et_babel_zulu"
...
if [ ${stage} -le 1 ]; then
    ...
    utils/combine_data.sh data/${train_set}_org data/tr_babel_haitian data/tr_babel_kurmanji data/tr_babel_tokpisin data/tr_babel_turkish
    utils/combine_data.sh data/${train_dev}_org data/dt_babel_haitian data/dt_babel_kurmanji data/dt_babel_tokpisin data/dt_babel_turkish
