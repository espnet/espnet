...
# data set
# non-target nagari languages is just bengali
train_set=tr_babel_nagari
train_dev=dt_babel_nagari

# Languages with Nagari script
recog_set="dt_babel_assamese et_babel_assamese dt_babel_bengali et_babel_bengali"
...
if [ ${stage} -le 1 ]; then
    ...
    utils/combine_data.sh data/${train_set}_org data/tr_babel_bengali
    utils/combine_data.sh data/${train_dev}_org data/dt_babel_bengali
