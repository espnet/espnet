...
# data set
train_set=tr_babel_georgian-mono
train_dev=dt_babel_georgian-mono

# Languages with Nagari script
recog_set="dt_babel_georgian et_babel_georgian"
...
if [ ${stage} -le 1 ]; then
    ...
    utils/combine_data.sh data/${train_set}_org data/tr_babel_georgian
    utils/combine_data.sh data/${train_dev}_org data/dt_babel_georgian
