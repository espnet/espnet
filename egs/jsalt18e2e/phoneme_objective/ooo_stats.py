...
for lang in langs:
    total = 0
    ooo = 0
    hyp_path = """exp/tr_babel10_blstmp_e4_subsample1_2_2_1_1_unit320_proj320_d1_unit300_location_aconvc10_aconvf100_mtlalpha0.33_phonemeweight0.33_adadelta_bs50_mli800_mlo150/decode_et_babel_{}_beam20_eacc.best_p0.0_len0.0-0.0_ctcw0.3/hyp.grapheme.trn""".format(lang)
