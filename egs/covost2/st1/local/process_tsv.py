...
parser.add_argument("save_path_src", type=str, default=None,
                    help="output filtered transcription path in the source language")
parser.add_argument("save_path_tgt", type=str, default=None,
...
def main():
    ...
    # save translation
    with codecs.open(args.save_path_src, "w", encoding="utf-8") as f_src, \
