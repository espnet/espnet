...
#sed -i "s~${srcspk}~${trgspk}~" ${asr_data_dir}/${set_name}/wav.scp
cp data/${trgspk}_${name}/text ${asr_data_dir}/${set_name}/text
sed -i "s~${trgspk}~${srcspk}~" ${asr_data_dir}/${set_name}/text
#sed -i "s~${srcspk}~${trgspk}~g" ${asr_data_dir}/${set_name}/utt2spk
#sed -i "s~${srcspk}~${trgspk}~g" ${asr_data_dir}/${set_name}/spk2utt
