...
class BF_module(nn.Module):
    def __init__(
        ...
        assert fasnet_type in ['fasnet', 'ifasnet'], "fasnet_type should be fasnet or ifasnet"
...
class FaSNet_TAC(FaSNet_base):
    def __init__(self, *args, **kwargs):
        ...
        self.all_BF = BF_module(self.filter_dim+self.enc_dim, self.feature_dim, self.hidden_dim, 
                                self.filter_dim, self.num_spk, self.layer, self.segment_size, fasnet_type='fasnet')
