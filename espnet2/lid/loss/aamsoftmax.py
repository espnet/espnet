# Code adapted from https://github.com/espnet/espnet/blob/master/espnet2/spk/loss/aamsoftmax.py
# Original code refer to https://github.com/clovaai/voxceleb_trainer/blob/master/loss/aamsoftmax.py
