...
#
# `MambaInnerFnNoOutProj` and related functions are added to the original script following Vision Mamba [1] (https://github.com/hustvl/Vim)
#
...
def mamba_inner_fn_no_out_proj_ref(
    xz, conv1d_weight, conv1d_bias, x_proj_weight, delta_proj_weight,
    A, B=None, C=None, D=None, delta_bias=None, B_proj_bias=None,
    C_proj_bias=None, delta_softplus=True
):
