...
class TransformerDecoder(BaseTransformerDecoder):
    ...
    def get_decoder_attn(
        ...
        """Get decoder attention states for TruCLeS Training."""
        _ = self.forward_one_step(tgt, tgt_mask, memory, cache = cache, return_hs = return_hs)
        
        return self.decoder_final_state
