...
class BeamSearchTransducer:
    ...
    def default_beam_search_v2(self, enc_out: torch.Tensor) -> List[Hypothesis]:
        """Beam search implementation.
    ...
    def time_sync_decoding_v2(self, enc_out: torch.Tensor) -> List[Hypothesis]:
        """Time synchronous beam search implementation.
    ...
    def align_length_sync_decoding_v2(self, enc_out: torch.Tensor) -> List[Hypothesis]:
        """Alignment-length synchronous beam search implementation.
