...
class SemanticDAC(AbsGANCodec):
    ...
    def __init__(
        ...
        self.discriminator = SemanticDACDiscriminator(**discriminator_params)
...
class SemanticDACGenerator(nn.Module):
    ...
    def forward(self, x: torch.Tensor, use_dual_decoder: bool = False):
        ...
        # Forward quantizer
        quantized_list, _, _, commit_loss, quantization_loss = self.quantizer(
...
class SemanticDACDiscriminator(nn.Module):
