...
class Text2Text:
    ...
    Examples:
        >>> text2text = Text2Text("nlu_config.yml", "nlu.pth")
        >>> text2text(audio)
    ...
    def __init__(
        self,
        nlu_train_config: Union[Path, str] = None,
        nlu_model_file: Union[Path, str] = None,
        ...
        # 1. Build NLU model
        scorers = {}
        nlu_model, nlu_train_args = NLUTask.build_model_from_file(
        ...
        if token_type is None:
            token_type = nlu_train_args.token_type
        if bpemodel is None:
            bpemodel = nlu_train_args.bpemodel
...
def inference(
    ...
    nlu_train_config: Optional[str],
    nlu_model_file: Optional[str],
    ...
    text2text_kwargs = dict(
        nlu_train_config=nlu_train_config,
        nlu_model_file=nlu_model_file,
    ...
    loader = NLUTask.build_streaming_iterator(
        data_path_and_name_and_type,
        dtype=dtype,
        batch_size=batch_size,
        key_file=key_file,
        num_workers=num_workers,
        preprocess_fn=NLUTask.build_preprocess_fn(text2text.nlu_train_args, False),
        collate_fn=NLUTask.build_collate_fn(text2text.nlu_train_args, False),
