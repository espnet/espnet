...
class Speech2Emotion:
    """Speech2Emotion class
...
def inference(
    ...
    speech2emotion = Speech2Emotion.from_pretrained(
        model_tag=model_tag,
        **speech2emotion_kwargs,
    )

    # 3. Build data-iterator
    loader = SERTask.build_streaming_iterator(
        data_path_and_name_and_type,
        dtype=dtype,
        batch_size=batch_size,
        key_file=key_file,
        num_workers=num_workers,
        preprocess_fn=SERTask.build_preprocess_fn(speech2emotion.ser_train_args, False),
        collate_fn=SERTask.build_collate_fn(speech2emotion.ser_train_args, False),
...
def get_parser():
    ...
    group.add_argument(
        "--ser_train_config",
        type=str,
        help="SER training configuration",
    )
    group.add_argument(
        "--ser_model_file",
        type=str,
