...
class VISingerGenerator(torch.nn.Module):
    ...
    def __init__(
        ...
        text_encoder_pw_conv_kernel_size: int = 1,
        text_encoder_pos_encoding_layer_type: str = "rel_pos",
        ...
        self.text_encoder = TextEncoder(
            ...
            positionwise_conv_kernel_size=text_encoder_pw_conv_kernel_size,
            positional_encoding_layer_type=text_encoder_pos_encoding_layer_type,
