...
def concat_fusion(speech_feats: torch.Tensor, 
    vision_feats: torch.Tensor, feat_lengths: torch.Tensor):
    """
...
FUSION_OPTIONS = {"concat": concat_fusion,
...
class MM_Fuser():
    ...
    def fuse(self, speech:torch.Tensor, vision:torch.Tensor, feat_lengths:torch.Tensor):
        """
