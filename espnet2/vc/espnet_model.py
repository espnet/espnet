...
class ESPnetVCModel(AbsESPnetModel):
    ...
    def collect_feats(
        self,
        source_speech: torch.Tensor,
        target_speech: torch.Tensor,
        source_speech_lengths: Optional[torch.Tensor] = None,
        target_speech_lengths: Optional[torch.Tensor] = None,
        spembs: Optional[torch.Tensor] = None,
        ...
        **kwargs,
        ...
        Args:
            ...
            text (Optional[Tensor]): Text index tensor (B, T_text).
            text_lengths (Optional[Tensor]): Text length tensor (B,).
        ...
        Returns:
            source_Dict[str, Tensor]: Dict of features.
            target_Dict[str, Tensor]: Dict of features.
        ...
        if self.pitch_extract is not None:
            ...
            target_pitch, target_pitch_lengths = self.pitch_extract(
                ...
                feats_lengths=target_feats_lengths,
                durations=durations,
                durations_lengths=durations_lengths,
            )
        if self.energy_extract is not None:
            source_energy, source_energy_lengths = self.energy_extract(
                source_speech,
                source_speech_lengths,
                feats_lengths=feats_lengths,
                durations=durations,
            ...
            target_energy, target_energy_lengths = self.energy_extract(
                target_speech,
                target_speech_lengths,
                feats_lengths=target_feats_lengths,
                durations=durations,
    ...
    def inference(
        self,
        source_speech: torch.Tensor = None,
        spembs: Optional[torch.Tensor] = None,
        text: Optional[torch.Tensor] = None,
        sids: Optional[torch.Tensor] = None,
        lids: Optional[torch.Tensor] = None,
        ...
        **decode_config,
        ...
        Args:
            ...
            spembs (Tensor): Speaker embedding tensor (D,).
            text (Optional[Tensor]): Text index tensor (T_text).
