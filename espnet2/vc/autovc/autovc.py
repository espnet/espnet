...
"""AutoVC related modules for ESPnet2."""
...
class AutoVC(AbsVC):
    """AutoVC module for voice conversion of in AutoVC described
    in `AUTOVC: Zero-Shot Voice Style Transfer with Only Autoencoder Loss`_,
    which converts the sequence of characters into the sequence of Mel-filterbanks.

    .. _`AUTOVC: Zero-Shot Voice Style Transfer with Only Autoencoder Loss`:
