...
class SyllableScoreFeats(AbsFeatsExtract):
    ...
    def forward(
        ...
        seg_label = torch.tensor(ListsToTensor(seg_label), dtype=torch.long, device=label.device)
        seg_label_lengths = torch.tensor(seg_label_lengths, dtype=torch.long, device=label.device)
        seg_midi = torch.tensor(ListsToTensor(seg_midi), dtype=torch.long, device=label.device)
        seg_midi_lengths = torch.tensor(seg_midi_lengths, dtype=torch.long, device=label.device)
        seg_duration = torch.tensor(ListsToTensor(seg_duration), dtype=torch.long, device=label.device)
        seg_duration_lengths = torch.tensor(seg_duration_lengths, dtype=torch.long, device=label.device)
...
def expand_to_frame(expand_len, len_size, label, midi, duration):
    ...
    seq_label = torch.tensor(ListsToTensor(seq_label), dtype=torch.long, device=label.device)
    seq_label_lengths = torch.tensor(seq_label_length, dtype=torch.long, device=label.device)
    seq_midi = torch.tensor(ListsToTensor(seq_midi), dtype=torch.long, device=label.device)
    seq_midi_lengths = torch.tensor(seq_midi_lengths, dtype=torch.long, device=label.device)
    seq_duration = torch.tensor(ListsToTensor(seq_duration), dtype=torch.long, device=label.device)
    seq_duration_lengths = torch.tensor(seq_duration_lengths, dtype=torch.long, device=label.device)
