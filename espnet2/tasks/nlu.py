...
from espnet2.nlu.espnet_model import ESPnetNLUModel
...
class NLUTask(AbsTask):
    ...
    def add_task_arguments(cls, parser: argparse.ArgumentParser):
        ...
        group.add_argument(
            ...
            default=get_default_kwargs(ESPnetNLUModel),
    ...
    @classmethod
    def build_model(cls, args: argparse.Namespace) -> ESPnetNLUModel:
        assert check_argument_types()
