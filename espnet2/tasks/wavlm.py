...
# WavLM self-supervised pretraining task.
...
from espnet2.wavlm.espnet_model import WavLMPretrainModel

# Importing this module registers WavLMForPreTraining with
# AutoModelForPreTraining, so HuggingFaceTransformersEncoder(do_pretrain=True)
# can load WavLM checkpoints.
from espnet2.wavlm import wavlm_for_pretraining  # noqa: F401
...
class WavLMTask(AbsTask):
    ...
    def add_task_arguments(cls, parser: argparse.ArgumentParser):
        ...
        group.add_argument(
            ...
            type=int,
            default=None,
            help="The number of classes in wavlm",
        )
