    ...
    def __init__(
        ...
        Args:
            ...
            discriminator_params (dict): Parameters for hifi-gan period discriminator
                module. The period parameter will be overwritten.
...
class HiFiGANScaleDiscriminator(torch.nn.Module):
    ...
    def __init__(
        ...
        Args:
            in_channels (int): Number of input channels.
            out_channels (int): Number of output channels.
            kernel_sizes (list): List of four kernel sizes. The first will be used for
                the first conv layer, and the second is for downsampling part, and the
                remaining two are for output layers.
...
class HiFiGANMultiScaleDiscriminator(torch.nn.Module):
    ...
    def __init__(
        ...
        Args:
            ...
            discriminator_params (dict): Parameters for hifi-gan scale discriminator
                module.
