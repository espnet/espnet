...
def generate_beats_encoder_checkpoint(
    ...
    for key, value in espnet_state_dict.items():
        if key.startswith("encoder."):
            model_state_dict[key[len("encoder.") :]] = value
    return model_state_dict


def read_and_write_checkpoint(
    espnet_model_checkpoint_path: str, espnet_model_config_path: str, output_path: str
):
    ...
    encoder_state_dict = generate_beats_encoder_checkpoint(espnet_state_dict)
