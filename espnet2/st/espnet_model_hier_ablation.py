...
class ESPnetSTHierAblationModel(AbsESPnetModel):
            ...
            if self.n_hier > 1:
                ...
                for i in range(self.n_hier):
                    loss_mt_ctc_i, cer_mt_ctc = self._calc_mt_ctc_loss(
                        encoder_hier_out_list[i], encoder_hier_out_lens_list[i], src_text, src_text_lengths
                    )
                    loss_mt_ctc += loss_mt_ctc_i
                loss_mt_ctc = loss_mt_ctc / self.n_hier
            else:
                loss_mt_ctc, cer_mt_ctc = self._calc_mt_ctc_loss(
                    encoder_hier_out, encoder_hier_out_lens, src_text, src_text_lengths
                )
        else:
