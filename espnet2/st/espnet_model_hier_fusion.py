...
class ESPnetSTHierFusionModel(AbsESPnetModel):
    ...
    def forward(
        ...
        # fusion
        encoder_fusion_out = encoder_hier_out + encoder_out

        # 2a. Attention-decoder branch (ST)
        loss_st_att, acc_st_att, bleu_st_att = self._calc_mt_att_loss(
            encoder_fusion_out, encoder_hier_out_lens, text, text_lengths, st=True
        )
