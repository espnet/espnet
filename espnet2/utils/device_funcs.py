...
def to_device(data, device=None, dtype=None, non_blocking=False, copy=False):
    ...
    if isinstance(data, dict):
        return {k: to_device(v, device, dtype, non_blocking, copy)
    ...
    # maybe namedtuple. I don't know the correct way to judge namedtuple.
        ...
        return type(data)(*[to_device(o, device, dtype, non_blocking, copy)
                            for o in data])
    elif isinstance(data, (list, tuple)):
        return type(data)(to_device(v, device, dtype, non_blocking, copy)
                          for v in data)
    elif isinstance(data, np.ndarray):
        return to_device(torch.from_numpy(data),
