...
from egs3.librispeech_100.asr.src.utils.collect_stats_local import collect_stats_local
from egs3.librispeech_100.asr.src.utils.collect_stats_parallel import (
