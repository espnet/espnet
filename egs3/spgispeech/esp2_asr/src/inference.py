...
def build_output(data, model_output, idx):
    ...
    egs3/TEMPLATE/esp2_asr/conf/inference.yaml's default) makes ESPnet3 group
    ...
    egs3/TEMPLATE/esp2_asr/src/inference.py:build_output, which this mirrors.
    ...
    used instead, exactly as egs3/librispeech_100/esp2_asr/src/inference.py does.
