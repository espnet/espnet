"""Mini AN4 classification dataset backed by TSV manifests."""
...
from egs3.mini_an4.esp2_cls.dataset.builder import MiniAn4ClsBuilder, resolve_data_root
...
class ManifestEntry:
    """One manifest row: utterance id, wav path, and class label."""
...
class MiniAn4ClsDataset(TorchDataset):
    """Mini AN4 dataset that returns ``{"speech", "label"}`` samples.
    ...
    Examples:
        >>> dataset = MiniAn4ClsDataset(split="valid")
