...
dataset_dict = DatasetDict(
    {
        ...
        "train-clean-360": Dataset.from_dict(
            gather_examples(f"{BASE_PATH}/train-clean-360")
        ),
        "train-other-500": Dataset.from_dict(
            gather_examples(f"{BASE_PATH}/train-other-500")
        ),
