...
def main():
    ...
    parser.add_argument("--config", type=str, default="config_globalMVN.yaml")
    ...
    # remove normalization configs for collect stats,
    # as stats file collect_stats won't be available before processing.
    normalize = None
    normalize_conf = None
