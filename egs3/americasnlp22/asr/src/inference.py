"""Inference output helpers for the AmericasNLP 2022 recipe."""
...
def build_output(data, model_output, idx):
    ...
    one dict per item is returned. Samples carry no identifier field, so the
    item index (in the dataset's deterministic corpus order) is used as the
    SCP row id.
    """
